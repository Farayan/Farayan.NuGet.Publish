...
namespace Farayan.NuGet.Publish.VisualStudio.AddIn
{
    ...
    public sealed class VSPackage : AsyncPackage
    {
        ...
        /// </summary>
        public const string PackageGuidString = "8a484bcd-7c5e-4cc1-aa50-7ba70733de2f";

        /// <summary>
        /// Initializes a new instance of the <see cref="NuGetPublishCfgPackage"/> class.
        /// </summary>
        public VSPackage()
        {
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            await NuGetPublishCfg.InitializeAsync(this);
        }
